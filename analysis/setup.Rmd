...
cran_packages <- c(
  "BiocManager", "Seurat", "ggplot2", "scales", "patchwork", "qs", "pheatmap",
  "hdf5r", "viridis", "devtools", "cli", "fs", "sf", "terra", "scales", "plotly"
)

install.packages(cran_packages)

bioc_packages <- c(
  "glmGamPoi", "scater", "scran" "SpatialExperiment", "ggspavis", "scran", "nnSVG", "SpatialFeatureExperiment", "Voyager", "RBioFormats", "BiocParallel", "bluster", "EBImage"
)
...
download.file("https://filesender.aarnet.edu.au/download.php?token=ec632836-0700-4921-9699-668bfe9657d2&files_ids=23608389",
              destfile = "stomics/raw/DY1_D0_stereo-seq.h5ad")

# LISTA single cell dataset (540MB)
download.file("https://filesender.aarnet.edu.au/download.php?token=ec632836-0700-4921-9699-668bfe9657d2&files_ids=23608386",
...
Please also install the raw xenium data by using the below code. The file size is large so it might take a few minutes to complete. 

```{r eval=F}
# Sample P5 CRC
# This file is ~12GB so will take a few minutes to download.
download.file("https://cf.10xgenomics.com/samples/xenium/2.0.0/Xenium_V1_Human_Colon_Cancer_P5_CRC_Add_on_FFPE/Xenium_V1_Human_Colon_Cancer_P5_CRC_Add_on_FFPE_outs.zip", 
