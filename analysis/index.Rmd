...
| Rmd file                                        | Topics                          |
|:---------                                       |:--------------------------------|
| [visium_01](visium_01.html) ~ 20 mins           | Introduction to data            |   
|                                                 | Loading data into Seurat object |
|                                                 | Interacting with Seurat object  |
|                                                 |                                 |
| [visium_02](visium_02.html) ~ 20 mins           | QC and Normalisation            | 
|                                                 |                                 |
| [visium_03](visium_03.html) ~ 20 mins           | Visualising spatial data        |
|                                                 |                                 |
| [visium_04](visium_04.html) ~ 30 mins           | Module score                    |
|                                                 | Deconvolution                   |
